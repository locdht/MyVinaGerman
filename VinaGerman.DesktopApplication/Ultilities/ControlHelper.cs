...
namespace VinaGerman.DesktopApplication.Utilities
{
    ...
    {
        public static string ShowImageDialog(string sDefaultFileName = "")
        {
            // Configure open file dialog box
            Microsoft.Win32.OpenFileDialog dlg = new Microsoft.Win32.OpenFileDialog();
            dlg.FileName = sDefaultFileName; // Default file name
            dlg.DefaultExt = ".png"; // Default file extension
            dlg.Filter = "Image Files (*.png, *.jpg, *.jpeg)|*.png;*.jpg;*.jpeg;*.JPG;*.JPEG;*.PNG"; // Filter files by extension 
        ...
        public static void ApplyLanguage(string langCode)
        {
            switch (langCode)
            {
                case "en-us": StringResources.Culture = new System.Globalization.CultureInfo("en-us"); break;
                case "nb-no": StringResources.Culture = new System.Globalization.CultureInfo("nb-no"); break;
                case "sv-se": StringResources.Culture = new System.Globalization.CultureInfo("sv-se"); break;
                case "vi-vn": StringResources.Culture = new System.Globalization.CultureInfo("vi-vn"); break;
            }
            LocalizedStrings resTranslation = (LocalizedStrings)System.Windows.Application.Current.FindResource("TranslatedStrings");
            resTranslation.RaisePropertyChanged("LocalizedResources");
        }
    }
